"""Trajectory-window batching utilities for ranking learning. See learning/README.md for details."""
...
class TrajectoryBatch:
    """Padded trajectory window batch container. See learning/README.md for details."""
...
def build_trajectory_windows(
    ...
    """Build trajectory-local windows with no cross-trajectory attention. See learning/README.md for details."""
