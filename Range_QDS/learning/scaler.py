"""Feature scaling utilities persisted across training and inference. See learning/README.md for details."""
...
@dataclass
class FeatureScaler:
    """Min-max scaler for points and query features. See learning/README.md for details."""
    ...
    def fit(cls, points: torch.Tensor, queries: torch.Tensor) -> FeatureScaler:
        """Fit scaler statistics from learning points and training queries. See learning/README.md for details."""
        if not torch.isfinite(points).all():
            ...
            raise ValueError(
                ...
                "Clean NaN/Inf rows in the data loader before learning."
            )
    ...
    def transform(
        ...
        """Transform points and queries with fitted statistics. See learning/README.md for details."""
    ...
    def to_dict(self) -> dict:
        """Serialize scaler statistics. See learning/README.md for details."""
        return {
    ...
    def from_dict(cls, payload: dict) -> FeatureScaler:
        """Deserialize scaler statistics. See learning/README.md for details."""
        return cls(
