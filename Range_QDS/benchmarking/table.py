...
BENCHMARK_REPORT_TABLE_COLUMNS = (
    ...
    "beats_uniform_query_local_utility",
    "beats_douglas_peucker_query_local_utility",
    "beats_temporal_random_fill_query_local_utility",
    "audit_compression_ratio_count",
    "audit_missing_temporal_random_fill_count",
    "audit_beats_uniform_query_local_utility_count",
    "audit_beats_douglas_peucker_query_local_utility_count",
    "audit_beats_both_query_local_utility_count",
    "audit_beats_temporal_random_fill_query_local_utility_count",
    "audit_low_beats_uniform_query_local_utility_count",
    "audit_low_beats_douglas_peucker_query_local_utility_count",
    "audit_low_beats_both_query_local_utility_count",
    "audit_low_beats_temporal_random_fill_query_local_utility_count",
    "audit_low_compression_ratio_count",
    "audit_min_vs_uniform_query_local_utility",
    "audit_mean_vs_uniform_query_local_utility",
    "audit_min_low_vs_uniform_query_local_utility",
    "audit_mean_low_vs_uniform_query_local_utility",
    "audit_min_vs_temporal_random_fill_query_local_utility",
    "audit_mean_vs_temporal_random_fill_query_local_utility",
    "audit_min_low_vs_temporal_random_fill_query_local_utility",
    "audit_mean_low_vs_temporal_random_fill_query_local_utility",
    ...
    "uniform_query_local_utility_score",
    "douglas_peucker_range_point_f1",
    "douglas_peucker_query_local_utility_score",
    ...
    "temporal_random_fill_query_local_utility_score",
    "mlqds_vs_temporal_random_fill_query_local_utility",
    "mlqds_avg_sed_km",
    "uniform_avg_sed_km",
