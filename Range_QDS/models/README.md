...
- Current training paths use one pure workload per model and output one
  score per point.
...
- Point features are 7 columns for baseline, 16 for range-aware, 17 for
  the compact workload-blind path, 24 for `range_prior`,
