"""Baseline simplification methods for AIS-QDS scoring. See scoring/README.md for details."""
...
class Method(Protocol):
    """Simplification method protocol. See scoring/README.md for details."""
    ...
    def simplify(
        ...
        """Return retained point mask. See scoring/README.md for details."""
        ...


@dataclass
class FrozenMaskMethod:
    """Scoring wrapper for a retained mask frozen before query scoring."""
...
class MLQDSMethod:
    ...
    def simplify(
        ...
        See ``scoring/README.md`` for details.
        """
        ...
        if str(self.selector_type).lower() == LEARNED_SEGMENT_BUDGET_SELECTOR_TYPE:
            return simplify_with_learned_segment_budget_v1(
                ...
                length_repair_score_protection_fraction=float(
                    self.learned_segment_length_repair_score_protection_fraction
                ),
            )
