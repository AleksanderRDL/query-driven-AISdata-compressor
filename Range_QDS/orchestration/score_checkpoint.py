...
Example, from repository root:
    ...
    uv run --group dev -- python -m orchestration.score_checkpoint \
        --checkpoint Range_QDS/artifacts/benchmarks/query_driven_workload_blind/runs/<run_id>/range_query_mix_workload_blind/benchmark_model.pt \
        --csv_path AISDATA/cleaned/<cleaned-ais-file.csv> \
        --n_queries 512 \
        --results_dir Range_QDS/artifacts/benchmarks/inference_range_query_mix_workload_blind
