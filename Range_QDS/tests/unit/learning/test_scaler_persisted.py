"""Tests scaler and model persistence keeps predictions identical. See learning/README.md for details."""
...
def test_scaler_persisted(tmp_path: Path) -> None:
    """Assert checkpoint reload yields identical predictions. See learning/README.md for details."""
