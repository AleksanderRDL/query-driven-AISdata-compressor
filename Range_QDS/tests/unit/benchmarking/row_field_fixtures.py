    ...
    return {
        ...
        "selector_budget_diagnostics": {
            "eval": {
                "budget_rows": [
                    {
                        "compression_ratio": 0.05,
                        "learned_slot_fraction_of_budget": 0.72,
                        "zero_learned_trajectory_fraction": 0.10,
                        "endpoint_only_trajectory_fraction": 0.05,
                    }
                ]
            }
        },
        ...
        "matched": {
            "MLQDS": {
                ...
                "range_query_local_interpolation_fidelity": 0.62,
            ...
            "uniform": {
                ...
                "range_query_local_interpolation_fidelity": 0.58,
                "geometric_distortion": {
                    "avg_sed_km": 0.55,
                    "max_sed_km": 3.5,
                    "avg_ped_km": 0.18,
            ...
            "DouglasPeucker": {
                ...
                "range_query_local_interpolation_fidelity": 0.55,
                "geometric_distortion": {
                    "avg_sed_km": 0.45,
                    "max_sed_km": 3.0,
                    "avg_ped_km": 0.15,
        ...
        "range_compression_audit": {
            "0.0100": {
                ...
                "TemporalRandomFill": {"query_local_utility_score": 0.11},
            },
            "0.0500": {
                "MLQDS": {
                    "query_local_utility_score": 0.46,
                ...
                "TemporalRandomFill": {"query_local_utility_score": 0.41},
            },
            "0.1000": {
                "MLQDS": {"query_local_utility_score": 0.52},
                "uniform": {"query_local_utility_score": 0.49},
                "DouglasPeucker": {"query_local_utility_score": 0.48},
                "TemporalRandomFill": {"query_local_utility_score": 0.52},
            },
        },
