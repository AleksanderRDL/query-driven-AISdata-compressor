"""Focused tests for the single-run evaluation stage."""
...
def test_evaluation_stage_runs_core_matched_audit_and_shift() -> None:
...
def test_evaluation_stage_rejects_unknown_final_metrics_mode() -> None:
