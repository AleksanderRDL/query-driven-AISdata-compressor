...
| File | Purpose |
| --- | --- |
| `model_score_conversion.py` | Canonical score conversion used by validation and final scoring. |
| `retained_mask_selectors.py` | Per-trajectory top-k retention with endpoint preservation. |
