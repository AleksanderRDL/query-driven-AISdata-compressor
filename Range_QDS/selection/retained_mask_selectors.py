"""Per-trajectory top-k simplification utilities. See selection/README.md for details."""
...
def simplify_with_scores(
    ...
    """Build retained mask by per-trajectory score top-k. See selection/README.md for details."""
